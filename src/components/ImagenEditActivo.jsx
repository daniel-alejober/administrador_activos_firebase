...
const ImagenEditActivo = () => {
  const { setUrlImg, file, setFile, dataAsset } = useActivo();
  ...
  return (
    ...
    >
      <img
        ...
        src={file ? URL.createObjectURL(file) : dataAsset?.urlImg}
        alt="activo"
      />
...
export default ImagenEditActivo;
